...
namespace HPYL_API.Controllers
{
    ...
    public class ShopcategoriesController : ApiController
    {
        ...
        //        return apiResult;
        //    }
        //    B.ShopcategoriesBLL bll = new B.ShopcategoriesBLL();
        //    List<HPYL.Model.Shopcategories> mlist = bll.GetModelList(Where);
        ...
        //    }
        //    B.ShopcategoriesBLL bll = new B.ShopcategoriesBLL();
        //    HPYL.Model.Shopcategories model = bll.GetModel(long.Parse(Ids));
